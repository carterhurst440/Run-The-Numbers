...
values
  ('main-app-comfort', 'Main App Comfort', 'blue', '{"accent":"#8fd6d2","accentSecondary":"#d9b78f","accentTertiary":"#91a6c8","heroButton":"#d6b07a","primaryButton":"#7ca2bc","actionColor":"#7ca2bc","primaryButtonDisabled":"#6f7f91","secondaryButton":"#55697f","secondaryButtonDisabled":"#5d6773","progressStart":"#8fd6d2","progressEnd":"#91a6c8","gold":"#e2c48f","muted":"#c7d3de","success":"#91c7a5","danger":"#d78d8d","bgStart":"#161a22","bgEnd":"#0f1318","panelStart":"#263140","panelEnd":"#171d26","headerStart":"#334355","headerEnd":"#202b38"}'::jsonb, '{"glowStrength":22,"surfaceContrast":56,"radiusScale":72,"flatSurfaces":false}'::jsonb, true),
  ('rtn-green-room', 'RTN Green Room', 'blue', '{"accent":"#8be0b3","accentSecondary":"#d8c07c","accentTertiary":"#73bda0","heroButton":"#9fdc8a","primaryButton":"#5ca775","actionColor":"#5ca775","primaryButtonDisabled":"#688676","secondaryButton":"#355b4a","secondaryButtonDisabled":"#586b62","progressStart":"#8be0b3","progressEnd":"#b7e48b","gold":"#dcc686","muted":"#cae6d4","success":"#9de6b7","danger":"#d68f8c","bgStart":"#0f1712","bgEnd":"#0a100c","panelStart":"#1e3a2b","panelEnd":"#122118","headerStart":"#29513d","headerEnd":"#173024"}'::jsonb, '{"glowStrength":26,"surfaceContrast":60,"radiusScale":68,"flatSurfaces":false}'::jsonb, true),
  ('guess-10-deep-blue', 'Guess 10 Deep Blue', 'blue', '{"accent":"#7ec8ff","accentSecondary":"#8fb0ff","accentTertiary":"#78e0ff","heroButton":"#9bb7ff","primaryButton":"#4e7fda","actionColor":"#4e7fda","primaryButtonDisabled":"#6a7fa8","secondaryButton":"#344c82","secondaryButtonDisabled":"#566884","progressStart":"#7ec8ff","progressEnd":"#9ab7ff","gold":"#d8c8a1","muted":"#c8d6f0","success":"#90d6c6","danger":"#d58d94","bgStart":"#0e1526","bgEnd":"#09101d","panelStart":"#1c315f","panelEnd":"#111c34","headerStart":"#29467e","headerEnd":"#16294e"}'::jsonb, '{"glowStrength":30,"surfaceContrast":58,"radiusScale":70,"flatSurfaces":false}'::jsonb, true),
  ('shape-traders-carbon', 'Shape Traders Carbon', 'steel-black', '{"accent":"#b8c2cf","accentSecondary":"#8d98a8","accentTertiary":"#d8dde5","heroButton":"#c1cad6","primaryButton":"#6d7786","actionColor":"#6d7786","primaryButtonDisabled":"#59616c","secondaryButton":"#303641","secondaryButtonDisabled":"#4d5560","progressStart":"#b8c2cf","progressEnd":"#dde3ea","gold":"#d6c3a2","muted":"#cfd5dd","success":"#9fb6aa","danger":"#b98792","bgStart":"#0d0f12","bgEnd":"#07080a","panelStart":"#1c2026","panelEnd":"#111418","headerStart":"#252a31","headerEnd":"#13161a"}'::jsonb, '{"glowStrength":12,"surfaceContrast":74,"radiusScale":58,"flatSurfaces":false}'::jsonb, true),
