          ...
          <tr>
            <td bgcolor="#ffffff" style="padding:32px 24px 0;background-color:#ffffff;">
              ...
              <div style="margin:0 0 32px;">
                <a href="${joinUrl}" data-ogsc="#0a0a09" data-ogsb="#c8ff00" style="display:block;padding:16px 24px;background-color:#c8ff00 !important;color:#0a0a09 !important;font-family:${MONO};font-size:12px;font-weight:800;letter-spacing:0.16em;text-decoration:none;text-transform:uppercase;text-align:center;">PLAY NOW &#8594;</a>
              </div>
