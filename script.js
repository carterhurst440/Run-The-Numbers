...
function getAdminThemePreviewMarkup(page = adminThemePreviewPage) {
  const pages = {
    home: `
      <div class="design-home-preview-app design-page-preview-app">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">BANK: 1,240 UNITS</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">NORMAL MODE</span>
            <span class="design-page-preview-icon"></span>
            <span class="design-page-preview-icon design-page-preview-icon-menu"></span>
          </div>
        </div>
        <div class="design-home-preview-hero">
          <h3 class="design-home-preview-title">WELCOME TO THE<br />CASINO FLOOR</h3>
          <p class="design-home-preview-subtitle">Track your rank, jump into live contests, and head to Play when you're ready to pick a table.</p>
          <button type="button" class="design-home-preview-play">PLAY</button>
          <p class="design-home-preview-typing">Analyst Carter Hurst, you're on. Review the numbers and report your position.</p>
          <section class="design-home-preview-rank">
            <div class="design-home-preview-rank-header">
              <div>
                <p class="design-home-preview-eyebrow">Current Rank</p>
                <div class="design-home-preview-rank-title-row">
                  <span class="design-home-preview-rank-icon">2</span>
                  <h4>Analyst · Tier 2</h4>
                </div>
              </div>
              <span class="design-home-preview-link">Rank Ladder</span>
            </div>
            <div class="design-home-preview-progress-grid">
              <div class="design-home-preview-progress-card">
                <div class="design-home-preview-progress-labels">
                  <span>Hands Played</span>
                  <span>1,240 / 2,000</span>
                </div>
                <span class="design-home-preview-progress-track"><span class="design-home-preview-progress-fill"></span></span>
              </div>
              <div class="design-home-preview-progress-card">
                <div class="design-home-preview-progress-labels">
                ...
                <span class="design-home-preview-progress-track"><span class="design-home-preview-progress-fill design-home-preview-progress-fill-alt"></span></span>
              </div>
            </div>
          </section>
          <section class="design-home-preview-contests">
            <div class="design-home-preview-contests-header">
              <h4>Contest Spotlight</h4>
              <span class="design-home-preview-link">See All Contests</span>
            </div>
            <article class="design-home-preview-contest-card">
              <div class="design-home-preview-contest-top">
                <div>
                  <h5>Weekly Bankroll Sprint</h5>
                  <p>Ends Sunday at 10 PM</p>
                </div>
                <span class="design-home-preview-fee">25 Units</span>
              </div>
              <p class="design-home-preview-prize">$250 Prize Pool</p>
              <div class="design-home-preview-threshold">
                <span class="design-home-preview-threshold-title">Boost unlock at 50 players</span>
                <span class="design-home-preview-threshold-bar"><span class="design-home-preview-threshold-fill"></span></span>
              </div>
            </article>
          </section>
        </div>
    ...
    `,
    "play-rtn": `
      <div class="design-page-preview-app design-page-preview-app-play">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">BANK: 700 UNITS</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">NORMAL MODE</span>
            <span class="design-page-preview-icon"></span>
            <span class="design-page-preview-icon design-page-preview-icon-menu"></span>
        ...
        <div class="design-play-preview-layout">
          <section class="design-play-preview-panel design-play-preview-panel-stage">
            <div class="design-play-preview-panel-header">
              <div>
                <p class="design-play-preview-kicker">Run The Numbers</p>
                <h4>Cards Dealt</h4>
              </div>
              <span class="design-page-preview-pill">Auto Deal</span>
            </div>
            <div class="design-play-preview-stage"></div>
          </section>
          <section class="design-play-preview-panel design-play-preview-panel-bets">
            <div class="design-play-preview-intro">Select a chip and place your bets in the betting panel.</div>
            <div class="design-play-preview-bet-header">
              <div>
                <p class="design-play-preview-kicker">Number Bets</p>
                <h4>Paytable 1</h4>
              </div>
              <span class="design-play-preview-link">Change</span>
            </div>
            <div class="design-play-preview-number-grid">
              <span>1</span><span>2</span><span>3</span><span>4</span><span>5</span>
              <span>6</span><span>7</span><span>8</span><span>9</span><span>10</span>
            </div>
            <div class="design-play-preview-chips">
              <span class="chip" data-value="5">5</span>
              <span class="chip" data-value="10">10</span>
              <span class="chip" data-value="25">25</span>
              <span class="chip" data-value="100">100</span>
            </div>
          </section>
        </div>
      </div>
    ...
    "play-guess10": `
      <div class="design-page-preview-app design-page-preview-app-play">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">BANK: 420 UNITS</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">NORMAL MODE</span>
            <span class="design-page-preview-icon"></span>
            <span class="design-page-preview-icon design-page-preview-icon-menu"></span>
        ...
        <div class="design-play-preview-layout">
          <section class="design-play-preview-panel design-play-preview-panel-stage">
            <div class="design-play-preview-panel-header">
              <div>
                <p class="design-play-preview-kicker">Guess 10</p>
                <h4>Cards Dealt</h4>
              </div>
              <span class="design-page-preview-pill">Beta</span>
            </div>
            <div class="design-guess-preview-revealed">
              <p class="design-play-preview-kicker">Revealed Cards</p>
              <div class="design-guess-preview-card-strip">
                <span class="design-guess-preview-card">A♠</span>
                <span class="design-guess-preview-card">7♥</span>
                <span class="design-guess-preview-card">10♦</span>
                <span class="design-guess-preview-card">Q♣</span>
              </div>
            </div>
          </section>
          <section class="design-play-preview-panel design-play-preview-panel-bets">
            <div class="design-play-preview-bet-header">
              <div>
                <p class="design-play-preview-kicker">Prediction</p>
                <h4>Color</h4>
              </div>
              <span class="design-page-preview-pill">Multiplier 2x</span>
            </div>
            <div class="design-guess-preview-spot-row">
              <div class="design-guess-preview-spot">
                <span>Wager</span>
                <strong>Place bets here</strong>
              </div>
              <div class="design-guess-preview-spot">
                <span>Pot Size</span>
                <strong>0</strong>
            ...
            <div class="design-guess-preview-category-row">
              <button type="button" class="design-guess-preview-choice is-active">Color</button>
              <button type="button" class="design-guess-preview-choice">Suit</button>
              <button type="button" class="design-guess-preview-choice">Rank</button>
            </div>
            <div class="design-guess-preview-category-row">
              <button type="button" class="design-guess-preview-choice is-active">Red</button>
              <button type="button" class="design-guess-preview-choice">Black</button>
            </div>
          </section>
        </div>
      </div>
    `,
    contests: `
      <div class="design-page-preview-app design-page-preview-app-content">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">CONTESTS</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">LIVE + ENDED</span>
            <span class="design-page-preview-icon"></span>
          </div>
        </div>
        <div class="design-page-preview-content">
          <section class="design-page-preview-panel">
            <div class="design-page-preview-section-head">
              <div>
                <p class="design-play-preview-kicker">Live Contests</p>
                <h4>Weekly Bankroll Sprint</h4>
              </div>
              <span class="design-home-preview-fee">25 Units</span>
            </div>
            <p class="design-page-preview-copy">Prize pool grows with entries and the top bankroll takes the win.</p>
            <div class="design-home-preview-threshold">
              <span class="design-home-preview-threshold-title">Boost unlock at 50 players</span>
              <span class="design-home-preview-threshold-bar"><span class="design-home-preview-threshold-fill"></span></span>
            </div>
          ...
          <section class="design-page-preview-panel">
            <div class="design-page-preview-section-head">
              <div>
                <p class="design-play-preview-kicker">Ended Contests</p>
                <h4>Weekend Numbers Rush</h4>
              </div>
              <span class="design-page-preview-link">Results</span>
            </div>
            <div class="design-preview-stat-row">
              <span>Prize paid</span>
              <strong>$500</strong>
            </div>
            <div class="design-preview-stat-row">
              <span>Winning score</span>
              <strong>2,420 units</strong>
            </div>
          </section>
        </div>
      </div>
    ...
    profile: `
      <div class="design-page-preview-app design-page-preview-app-content">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">PROFILE</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">ANALYST CARTER HURST</span>
            <span class="design-page-preview-icon"></span>
          </div>
        </div>
        <div class="design-page-preview-content">
          <section class="design-page-preview-panel">
            <div class="design-page-preview-section-head">
              <div>
                <p class="design-play-preview-kicker">Account</p>
                <h4>Profile Details</h4>
              </div>
            </div>
            <div class="design-preview-stat-row"><span>First Name</span><strong>Carter</strong></div>
            <div class="design-preview-stat-row"><span>Last Name</span><strong>Hurst</strong></div>
            <div class="design-preview-stat-row"><span>Email</span><strong>analyst@carterscasino.app</strong></div>
          </section>
          <section class="design-page-preview-panel">
            <div class="design-page-preview-section-head">
              <div>
                <p class="design-play-preview-kicker">Contest Medals</p>
                <h4>Recent Finishes</h4>
              </div>
            </div>
            <div class="design-preview-badge-row">
              <span class="design-page-preview-pill">1st</span>
              <span class="design-page-preview-pill">2nd</span>
              <span class="design-page-preview-pill">3rd</span>
            </div>
          </section>
        </div>
      </div>
    ...
    "admin-ranks": `
      <div class="design-page-preview-app design-page-preview-app-content">
        <div class="design-page-preview-header">
          <div class="design-page-preview-bank">ADMIN</div>
          <div class="design-page-preview-header-actions">
            <span class="design-page-preview-mode">RANKS</span>
            <span class="design-page-preview-icon"></span>
          </div>
        </div>
        <div class="design-page-preview-content">
          <section class="design-page-preview-panel">
            <div class="design-page-preview-section-head">
              <div>
                <p class="design-play-preview-kicker">Assigned Theme</p>
                <h4>Analyst · Tier 2</h4>
              </div>
              <span class="design-page-preview-pill">Blue</span>
            </div>
            <div class="design-home-preview-progress-grid">
              <div class="design-home-preview-progress-card">
                <div class="design-home-preview-progress-labels">
...
function renderAdminThemePreview(page = adminThemePreviewPage) {
  ...
  adminThemePreviewEl.dataset.previewPage = page;
